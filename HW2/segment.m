...
[ids_panda, means_panda, ssd_panda] = restarts(panda_2d, 3, 3, 3);
[ids_cardinal, means_cardinal, ssd_cardinal] = restarts(cardinal_2d, 3, 3, 3);
[ids_pittsburgh, means_pittsburgh, ssd_pittsburgh] = restarts(pittsburgh_2d, 3, 3, 3);
...
% uint8 before displaying (im2uint8(I);)
